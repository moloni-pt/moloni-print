...
class Labels
{
    ...
    public $created_by = 'Documento emitido por ';
    public $created_by_v2 = 'Documento emitido por ';
    public $date = 'Data';
    ...
    public $document_is_not_invoice = 'Este documento não serve de fatura';
    ...
    public $powered_by = 'Emitido por | moloni.pt';
    public $price = 'Preço';
    public $processed_by = 'Processado por programa certificado Nº 1455/AT';
    public $processed_by_v2 = 'Processado por programa certificado Nº 2860/AT';
